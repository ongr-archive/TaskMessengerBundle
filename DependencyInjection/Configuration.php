                    ...
                    ->children()
                        ->arrayNode('amqp')
                            ->children()
                                ...
                                ->end()
                                ->scalarNode('factory')
                                    ->defaultValue('ongr_task_messenger.simple_connection_factory')
                                ->end()
                                ->scalarNode('publisher')
                                    ->defaultValue('ongr_task_messenger.publisher.amqp')
                                ->end()
                                ->scalarNode('host')
                        ...
                        ->arrayNode('beanstalkd')
                            ->children()
                                ...
                                ->end()
                                ->scalarNode('publisher')
                                    ->defaultValue('ongr_task_messenger.publisher.beanstalkd')
                                ->end()
                                ->scalarNode('class')
